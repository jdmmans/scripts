...
# French and or Russian flag time
crr <- ab2 %>% dplyr::filter(row_number() %% 3 == 0)
crr1 <- ab2 %>% dplyr::filter(row_number() %% 3 == 1)
crr2 <- ab2 %>% dplyr::filter(row_number() %% 3 == 2)
crr[crr == "black"] <- "black" 
crr[crr == "white"] <- "red"
crr1[crr1 == "black"] <- "black" 
crr1[crr1 == "white"] <- "blue"
ab2 <- rbind(crr2,crr1,crr)
ab2 <- arrange(ab2, factor(Isolate, levels = cord2))
